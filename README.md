...
- **Behavioral platform cues (15%)**: response rates, active logins, GitHub activity.
- **Logistics (5%)**: Office proximity (Noida/Pune) and notice period bounds.
- **Disqualifiers (Multiplier)**: Disqualifies candidates with purely outsourcing consulting backgrounds (e.g., TCS/Wipro/Infosys only) or pure research-only academic backgrounds.
